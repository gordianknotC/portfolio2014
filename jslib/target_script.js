...
;(function(){
// modjewel.js
var theXMLHttpRequest=window.nativeXMLHttpRequest?window.nativeXMLHttpRequest:window.XMLHttpRequest;
(function(){
...
HookSites.XMLHttpRequest_open = HookLib.addHookSite(theXMLHttpRequest.prototype, "open");
HookSites.XMLHttpRequest_send = HookLib.addHookSite(theXMLHttpRequest.prototype, "send");
HookSites.XMLHttpRequest_addEventListener = HookLib.addHookSite(theXMLHttpRequest.prototype, "addEventListener");
...
if (xhr.readyState === theXMLHttpRequest.OPENED) {
...
} else if (xhr.readyState === theXMLHttpRequest.DONE) {
